...
Scenario: Move Roteiro to Lixeira 
	...
	And I can see a roteiro with id "lixeira_teste"
...
Scenario: Permanently Delete One Roteiro
    Given I am at the roteiros page
    And I cannot see a roteiro named "Eng. Requisitos" with Id equal to "eng_requisitos"
    Then I go to Novo Roteiro page
    And I try to create the roteiro with titulo "Eng. Requisitos" id "eng_requisitos" meta "Eng. Req." and the questions: "Q1?" and "Q2?" 
	...
	And I'm still at the Lixeira Page
